			...
			v := ast.Visitor {
				...
				visit = proc(visitor: ^ast.Visitor, node: ^ast.Node) -> ^ast.Visitor {
					...
					case ^ast.Call_Expr:
						...
						if selector.field.name != "compiled" {
							return nil
						}
						...
						c.relpath = strings.clone(unqouted_path, s.allocator)
						c.fullpath = filepath.join({s.pkg.fullpath, unqouted_path}, s.allocator)
						c.pos = path.pos
...
write_generated_file_header :: proc(w: io.Writer, has_calls: bool) {
	if has_calls {
		fmt.wprintf(w, "/* This file was generated by temple on %v - DO NOT EDIT! */\n", time.now())
	}

	io.write_string(w, `/* This file is generated by temple - DO NOT EDIT! */
...
write_transpiled_call :: proc(w: io.Writer, call: Compile_Call) {
	...
	data, ok := os.read_entire_file_from_filename(call.fullpath)
	if !ok {
		warn(nil, "unable to read template file at %q, skipping", call.fullpath)
		return
	}
	...
	if !pok {
		warn(nil, "there were errors parsing the template at %q, skipping", call.fullpath)
		return
	}

	transpile(w, call.relpath, templ)
}
